...
<?php 
  ...
  include "src/sidebar.php";
    ...
    if(isset($_GET['actionIdForActive'])){
        ...
        $statusActive = $teacherClass->statusActiveById($id);
    }

    if(isset($_GET['actionIdForDeactive'])){
        $id = $_GET['actionIdForDeactive'];
        $statusDeactive = $teacherClass->statusDectiveById($id);
    }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Active paid Teachers</h3>
            </div>
            <!-- /.box-header -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                        <?php
                        $allPaidTeacher = $teacherClass->getAllPaidTeacher();
                        foreach ($allPaidTeacher as $teacher){
                            ?>
                            <tr>
                                <td>
