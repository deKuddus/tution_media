<?php
  ...
  include "src/sidebar.php";
    ...
    if(isset($_GET['actionIdForActive'])){
        ...
        $statusActive = $teacherClass->statusActiveByIdFromActivePage($id);
    }

    if(isset($_GET['actionIdForDeactive'])){
        $id = $_GET['actionIdForDeactive'];
        $statusDeactive = $teacherClass->statusDectiveByIdFromActivePage($id);
    }
                          ...
                          <div class="box-body">
                              <div class="table-responsive">
                                  <table id="example1" class="table table-bordered table-striped">
                                      ...
                                      <tbody>
                                      <?php
                                      $allActiveTeacher = $teacherClass->getAllActiveTeacher();
