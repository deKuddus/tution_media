...
<?php 
  ...
  include "src/sidebar.php";
    ...
    if(isset($_GET['actionIdForActive'])){
        ...
        $statusActive = $teacherClass->statusActiveByIdFromFreePage($id);
    }

    if(isset($_GET['actionIdForDeactive'])){
        $id = $_GET['actionIdForDeactive'];
        $statusDeactive = $teacherClass->statusDectiveByIdFromFreePage($id);
    }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                <h3 class="box-title">All Active free Teachers</h3>
            </div>
            <!-- /.box-header -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                        <?php
                        $allFreeTeacher = $teacherClass->getAllFreeTeacher();
                        foreach ($allFreeTeacher as $teacher){
                            ?>
                            <tr>
                                <td>
                                    ...
                                    <?php  }else{?>
                                        <span class="label label-info">Deactive</span>
                                    <?php } ?>
