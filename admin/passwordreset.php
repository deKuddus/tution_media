...
if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['passwordReset'])){
    $resetPassword = $admin->resetAdminPassword($_POST);
}
?>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="passwordreset.php" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="confirmPassword" placeholder="Type password again">
            </div>
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" name="passwordReset" class="btn btn-primary btn-block btn-flat">Reset</button>
